...
- **Compte de produit sur la fiche article** — chaque article du catalogue porte **son** compte de produit, choisi une fois plutôt que ressaisi à chaque facture ; la ligne montée depuis le catalogue le reprend automatiquement, et la chaîne de repli compte trois maillons (ligne → article → société) ✓
