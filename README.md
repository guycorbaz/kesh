...
| v0.11.0 | **E23 Dette i18n** (#316, #283) — les écrans réclamaient des libellés que **aucun** des quatre catalogues ne contenait : Kesh servait alors du **français correct** à un germanophone, sans erreur ni avertissement. Trois rollouts livrés (contacts, factures fournisseurs, réglages & lots de paiement), quatre garde-fous posés pour que le défaut ne puisse plus revenir en silence. ⚠️ **En régime allégé depuis le 2026-08-22** : la priorité va au fonctionnement en **français** de la première version de production ; les traductions se finissent ensuite | 🚧 En cours |
| v0.6+ | E15 Justificatifs, Lettrage & Compléments (inc. journaux personnalisables) | 📋 Backlog |
