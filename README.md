...
| v0.12.0 | **E15 Lettrage, justificatifs & compléments** — **lettrage** des écritures entre elles (facture ↔ paiement) pour savoir ce qui reste réellement ouvert sur un compte client, là où un simple marqueur « payée » ne dit rien des paiements partiels ni d'un règlement couvrant plusieurs factures ; **pièces justificatives** attachées aux écritures ; modèles de documents personnalisables et manuels embarqués | 🚧 En cours |
