...
| v0.5 (suite) | **E20 Envoi de factures par e-mail** (#224) — modèles d'e-mail multilingues FR/DE/IT/EN éditables (Réglages, Admin), envoi de la facture PDF QR au contact (langue & civilité du contact, destinataire verrouillé) ; **E16 Facturation avancée** (compte produit par ligne, PDF complet), E14 Clôture d'exercice, E15 Justificatifs, Lettrage & Compléments (inc. journaux personnalisables) | 🚧 En cours |
