...
| v0.8.0 (en cours) | **E14 Clôture d'exercice** (#232) — **report à-nouveau automatique** : soldes de bilan cumulés en temps réel d'un exercice à l'autre (modèle virtuel Odoo/Flectra), lignes « Résultat reporté » + « Résultat de l'exercice » au bilan, exports CSV/PDF, clôture = verrou (immutabilité CO 957-964) ; réouverture d'exercice, rôles de comptes configurables, bilan d'ouverture à suivre | 🚧 En cours |
