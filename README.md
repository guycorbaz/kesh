...
| v0.2 (suite) | **E12 Paiements** (pain.001, paiement en deux temps, **import de factures depuis un dossier avec décodage QR-facture**), **E16 Facturation avancée** (compte produit par ligne, PDF complet), E13 Budgets, E14 Clôture d'exercice, E15 Justificatifs, Lettrage & Compléments (inc. journaux personnalisables) | 🚧 En cours |
