...
- **TVA suisse** — configuration des taux (CRUD admin, séries temporelles par catégorie) ✓, calcul de la TVA due par ligne de facture ✓ et rapport TVA par période (PDF/CSV) ✓
...
| v0.2 (suite) | **E11 TVA Suisse** — configuration des taux + calcul de la TVA due et rapport par période (TVA récupérable + comptes TVA différés, story #180) | ✅ Done |
