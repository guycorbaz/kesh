...
- **Factures fournisseurs & règlement** — enregistrement d'une facture reçue (écriture d'achat automatique : charge + impôt préalable + dette créancier), règlement binaire en un clic (virement bancaire → compte source, ou compte interne libre), annulation de la facture et **annulation du règlement** par contre-passation ✓
