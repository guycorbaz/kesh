...
| v0.6.0 (prévu) | **E20 Envoi de factures par e-mail** (#224) — modèles d'e-mail multilingues FR/DE/IT/EN éditables (Réglages, Admin), envoi de la facture PDF QR au contact (langue & civilité du contact, destinataire verrouillé, Reply-To société) | 🚧 PR en cours (6/6 stories livrées) |
