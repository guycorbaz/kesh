...
| v0.12.0 | **E24 « Les livres justes »** — première vague de correction issue d'un **audit par trois experts** (comptable, fiscaliste, directeur financier) mené le 2026-08-26 sur l'ensemble du logiciel. ⚠️ **Le défaut fondateur** : l'encaissement d'une facture client ne produisait **aucune écriture comptable** — le compte débiteurs accumulait des débits jamais crédités, la banque était sous-évaluée, et **le rapprochement bancaire était impossible**. Le mode d'échec est silencieux : le bilan reste équilibré, aucun contrôle ne rougit. Cette vague livre l'**écriture d'encaissement**, le **grand livre** (l'extrait de compte, qui n'existait pas — « l'instrument qui rend les autres défauts visibles »), une **piste d'audit inaltérable et consultable**, et la correction des comptes de clôture. | 🚧 En cours |
| v0.13.0 (prévu) | **E15 Lettrage, justificatifs & compléments** — ⛔ **gelé le 2026-08-26** : le lettrage rapproche deux lignes d'un même compte, or **une facture cliente payée n'en a qu'une** tant que l'encaissement ne s'écrit pas. La spécification est faite — onze passes de revue, jugée comptablement juste — et attend l'E24. | 📋 Gelé |
