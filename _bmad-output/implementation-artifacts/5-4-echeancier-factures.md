...
8. **Given** l'utilisateur saisit une date de paiement dans le futur ou antérieure à `invoice.date`, **When** soumission, **Then** 400 `INVALID_INPUT` avec message i18n précis (« La date de paiement ne peut être postérieure à aujourd'hui » / « antérieure à la date de facture »).
