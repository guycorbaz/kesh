...
⛔ **DÉCOUPÉE le 2026-09-24** en **25-3-a-1** (client, `refs #414`) et **25-3-a-2** (fournisseur,
`closes #414`, derrière la première) — règle de découpage déclenchée : sévérité de la passe 2
(MEDIUM) → passe 3 (HIGH + MEDIUM), non décroissante ; découpage proposé indépendamment par les deux
lentilles de la passe 3. **Cette fiche reste la SOURCE DES FAITS** : ses trois passes, son Change
Log et ses arbitrages valent pour les deux filles. Les constats de la passe 3 sont corrigés **dans
les filles**, pas ici. ⛔ **Q5 tranchée par Guy** : un règlement d'exercice clos ne s'annule pas,
rouvrir l'exercice reste le chemin.
...
| 2026-09-24 | split | **Q5 tranchée par Guy** : refus d'annuler un règlement d'exercice clos, la réouverture reste possible et c'est le chemin (ma recommandation contraire, retirée après la passe 3, n'est pas retenue). **Découpée** en 25-3-a-1 (client) et 25-3-a-2 (fournisseur), qui intègrent chacune les corrections de la passe 3 de leur côté. |
