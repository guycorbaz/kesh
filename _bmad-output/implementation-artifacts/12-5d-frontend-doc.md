...
- [ ] **T-d8 — Doc** (AC9-13 + AC12-bis) : `.env.example` (5 vars), `docker-compose.yml` + `docker-compose.prod.yml` (volumes+env), `CHANGELOG.md`, `README.md`, `website/roadmap.html`+`index.html`, `docs/manual/fr/admin-manual.tex` (+ régénérer PDF `make fr`, NE PAS bumper `\keshVersion`).
