...
- `ReconciliationProposals.svelte` (table propositions avec radios per-tx, boutons Accepter/Rejeter batch, panneau échecs partiels affichant `failed[]` du backend).
