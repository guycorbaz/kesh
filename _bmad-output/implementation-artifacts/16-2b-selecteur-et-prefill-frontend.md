...
- [ ] **T-B2 — Fiche produit** (AC-B1, AC-B2, AC-B6)
  ...
  - [ ] Passer **`loadError`**, comme le font `InvoiceForm.svelte:823` et `VatPurchaseAssistant.svelte:161`. Sans lui, un `fetchAccounts` en échec laisse le champ **vide et muet** — le symptôme même qu'AC-B2 prévient, par une autre cause, et que **D-B2** garantit de ne pas signaler.
