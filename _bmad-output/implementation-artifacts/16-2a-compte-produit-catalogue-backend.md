...
**Statut : `ready-for-dev`. Boucle NON convergée** — 1 HIGH en passe 2 impose une **passe 3** (§ *Review Iteration Rule*). Trend `3H/4M/3L → 1H/7M/3L`. LLM à faire tourner : ni Opus (passe 1), ni Sonnet (passe 2) — **Haiku**, contexte frais, sur le diff aplati des deux passes.
