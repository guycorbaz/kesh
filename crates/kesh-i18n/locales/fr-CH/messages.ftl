...
imported-supplier-invoices-save = Valider la facture
...
supplier-invoices-scan = Scanner un QR-facture
supplier-invoices-scan-detected = Créancier détecté
supplier-invoices-scan-failed = Impossible de lire cette image.
supplier-invoices-scan-hint = Chargez une image du QR-facture pour pré-remplir IBAN, référence et montant.
supplier-invoices-scan-no-qr = Aucun QR-code détecté sur cette image.
supplier-invoices-scan-ok = QR-facture lu — coordonnées pré-remplies.
...
imported-supplier-invoices-error-no-qr-code-found = Aucun QR-facture détecté
