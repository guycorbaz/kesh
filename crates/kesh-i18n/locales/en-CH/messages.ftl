...
error-api-key-admin-forbidden = Administration routes are not reachable with an API key, whatever the role of its creator. Use the web interface.
...
error-account-has-entries = This account carries { $count } entry/entries: changing its type would reclassify its entire history, including closed fiscal years.
error-foreign-key = Invalid reference
error-journal-entry-linked-to-invoice = This journal entry was generated by a validated invoice and cannot be deleted directly. Unvalidate the invoice first, or correct it with a credit note.
error-check-constraint = Invalid value
error-illegal-state = Illegal state transition
error-invoice-unvalidate-blocked-settled = This invoice carries a payment, even a partial one: cancel it first.
error-invoice-unvalidate-blocked-credited = This invoice is credited by a credit note, which is already the correction.
error-invoice-unvalidate-blocked-reminders = This invoice has a reminder history: removing it would erase the proof of collection.
error-invoice-unvalidate-blocked-emailed = This invoice was sent to the client: correct it with a credit note.
error-invoice-unvalidate-blocked-matched = This invoice's journal entry is matched to a bank transaction: undo the match first.
...
accounts-retype-title = Change the type of account { $number }?
accounts-retype-warning = This account carries { $count } entry/entries. Changing its type reclassifies its entire history: the amounts move from the income statement to the balance sheet, or the other way round.
accounts-retype-closed-years = Closed fiscal years affected: { $years }. Their result will change with no entry to explain it.
accounts-retype-confirm = Change the type anyway
...
journal-entry-form-col-project = Project
journal-entry-project-archived = Project archived
journal-entry-project-none = — None
...
journal-entries-filter-account = Account
journal-entries-filter-account-all = All
...
contact-duplicate-others-count-one = and 1 more
...
contact-form-client-number-hint = Appears on the invoice PDF so your client can match it to their supplier file.
...
contact-filter-search-placeholder = Search by name, email, client number or UID without separators…
...
contact-error-client-number-duplicate = A contact with this client number already exists
...
invoices-description-error-empty = The label is empty
invoices-description-error-too-long = The label exceeds { $max } characters (currently { $actual })
invoices-description-error-control-char = Control character not allowed
invoices-description-error-unknown-placeholder = Unknown placeholder: {"{"}{ $name }{"}"}
invoices-description-error-no-placeholder = The label must contain at least one known placeholder ({"{"}YEAR{"}"}, {"{"}INVOICE_NUMBER{"}"}, {"{"}CONTACT_NAME{"}"})
invoices-format-error-empty = The numbering format is empty
invoices-format-error-too-long = The format exceeds { $max } characters (currently { $actual })
invoices-format-error-bad-chars = The format contains disallowed characters
invoices-format-error-bad-padding = Invalid padding {"{"}SEQ:{ $n }{"}"} — must be between 1 and { $max }
invoices-format-error-unknown-placeholder = Unknown placeholder: {"{"}{ $name }{"}"}
invoices-format-error-no-placeholder = The format must contain at least one known placeholder ({"{"}YEAR{"}"}, {"{"}FY{"}"}, {"{"}SEQ{"}"}, {"{"}SEQ:NN{"}"})
invoices-format-error-rendered-too-long = The format would produce a { $len }-character number (max { $max })
...
invoice-settle-button = Record a settlement
invoice-settle-button-short = Settle
invoice-settle-dialog-title = Record a settlement
invoice-settle-dialog-body = The settlement produces its accounting entry, whatever the method.
invoice-settle-type-label = Settlement method
invoice-settle-type-bank = Bank transfer
invoice-settle-type-internal = Cash or other account
invoice-settle-bank-label = Bank account
invoice-settle-account-label = Account
invoice-settle-account-placeholder = — Choose an account
invoice-settle-amount-label = Amount
invoice-settle-date-label = Settlement date
invoice-settle-confirm = Record the settlement

## Story 25-3-a-1 (#414) — annuler un règlement client
invoices-settlements-title = Settlements
invoices-settlements-col-date = Date
invoices-settlements-col-amount = Amount
invoices-settlements-col-mode = Method
invoices-settlements-col-entry = Entry
invoices-settlements-entry-link = View the entry
invoices-settlements-type-bank = Bank transfer
invoices-settlements-type-internal = Cash or other account
invoices-settlement-cancel-button = Cancel the settlement
...
settlement-cancel-blocked-fiscal-year-closed = This settlement belongs to a closed fiscal year: an administrator must reopen the fiscal year before it can be cancelled.
settlement-cancel-blocked-bank-match = This settlement is reconciled with a bank transaction: undo the reconciliation first, from this record or the bank import detail.
settlement-cancel-blocked-account-archived = An account of this settlement has been archived: reactivate it to be able to cancel the settlement.
...
reconciliation-cancel-blocked-account-archived = An account of the entry of this reconciliation has been archived: reactivate it to be able to cancel the reconciliation.
reconciliation-cancel-blocked-no-fiscal-year = No open fiscal year covers today's date: create it to be able to cancel this reconciliation.
reconciliation-cancel-button = Cancel the reconciliation
reconciliation-cancel-loading = Reading the reconciliation…
reconciliation-cancel-confirm-entry = A reversing entry dated today will be posted, and the transaction will be back to reconcile.
reconciliation-cancel-confirm-invoice = A reversing entry dated today will be posted, the settlement of invoice { $invoice } will be removed and the invoice will be back to pay; the transaction will be back to reconcile.
reconciliation-cancel-confirm-submit = Confirm the cancellation
reconciliation-cancel-dismiss = Close
reconciliation-cancel-done = Reconciliation cancelled.
reconciliation-cancel-entry-link = View the entry
reconciliation-cancel-column = Reconciliation
invoice-settle-success-full = Settlement recorded — invoice settled
invoice-settle-success-partial = Partial settlement recorded
invoice-error-settled-on-required = Settlement date required
...
bank-accounts-error-qr-iban-not-qr = This IBAN is not a QR-IBAN. If your bank has not issued you a dedicated QR-IBAN for QR-bills, leave this field empty: your regular IBAN is sufficient.
bank-accounts-help-qr-iban = Fill in only if your bank has issued you a dedicated QR-IBAN for QR-bills (a special number with an identifier in the 30000–31999 range). Otherwise leave this field empty: your regular IBAN is sufficient to generate QR-bills.
...
reconciliation-manual-project-label = Analytical project (optional)
reconciliation-manual-project-none = — None
reconciliation-rules-default-project-archived = Project archived
reconciliation-rules-default-project-none = — None
reconciliation-rules-labels-default-project = Default analytical project
reconciliation-split-add-line = + Add a line
reconciliation-split-bank-account-not-configured = The bank account is not configured. Configure the linked ledger account under /bank-accounts.
reconciliation-split-error-no-proposal = No transaction selected
reconciliation-split-project-none = — None
reconciliation-split-remove-line = -
reconciliation-split-th-account = Account
reconciliation-split-th-amount = Amount
reconciliation-split-th-description = Description
reconciliation-split-th-project = Project
reconciliation-split-value-date-label = Value date
reconciliation-split-error-min-lines = At least { $min } lines are required
reconciliation-split-error-max-lines = At most { $max } lines
reconciliation-split-error-account-required = Line { $line }: account required
reconciliation-split-error-amount-positive = Line { $line }: amount > 0 required
reconciliation-split-error-description-too-long = Line { $line }: description too long (max { $max })
...
reports-fiscal-year-label = Fiscal year
reports-generate = Generate
reports-project-expenses = Expenses by project
reports-project-expenses-col-account = Account
reports-project-expenses-col-amount = Amount
reports-project-expenses-empty = No expenses tagged on this project for the period.
reports-project-expenses-subtotal = Subtotal
reports-project-expenses-title = Expenses by project
reports-project-expenses-total = Total expenses
reports-project-mode-cumulative = Cumulative since inception
reports-project-mode-fiscal-year = Fiscal year
reports-project-mode-label = Period
reports-project-return = Return by project
reports-project-return-col-cost = Invested cost
reports-project-return-col-net = Net result
reports-project-return-col-project = Project
reports-project-return-col-return = Return
reports-project-return-col-revenue = Revenue
reports-project-return-empty = No movements tagged on this project for the period.
reports-project-return-title = Return by project
reports-project-return-total = Total
reports-project-selector-label = Project
reports-project-selector-placeholder = — Choose a project
...
reports-filename-general-ledger = general-ledger
...
export-global-description = Export your entire accounting as CSV in a ZIP file: chart of accounts, journal entries, sales and supplier invoices, credit notes, settlements, projects, contacts, banking data and audit log. Use this export to archive your data for 10 years (Swiss CO art. 958f) or to migrate to another application.
...
export-global-content-includes = The export contains 30 tables: chart of accounts, fiscal years, journal entries and lines, contacts and contact persons, products, projects, sales invoices and lines, credit notes and lines, settlements, supplier invoices and lines, imported supplier documents, payment batches and items, bank accounts, imports and transactions, VAT rates, invoicing and dunning settings, reconciliation rules, import profiles, audit log — plus a metadata.json manifest with the SHA-256 hash of each file.
export-global-content-excludes = Deliberately not included: numbering counters (the numbers already appear on the documents themselves), API keys and session tokens (these are secrets), the user registry (the audit log carries each author's name as recorded at the time), email templates and installation state (configuration, not accounting). Supporting documents (files) are not yet included.
...
common-save = Save
common-admin-only = Administrators only.
common-edit = Edit
...
dunning-delete-error = Delete failed.
dunning-grace-error = The grace period must be a positive integer.
dunning-settings-conflict = The settings changed in the meantime, reloaded.
...
invoice-detail-project-label = Analytical project
invoice-field-project = Analytical project (optional)
invoice-project-archived = Project archived
invoice-project-current = Current project
invoice-project-none = — None
...
settings-invoicing-numbering-title = Numbering
settings-invoicing-seq-range = (NN between 1 and 10)
settings-invoicing-description-help = Placeholders: {"{"}YEAR{"}"}, {"{"}INVOICE_NUMBER{"}"}, {"{"}CONTACT_NAME{"}"}.
settings-invoicing-description-invalid = Invalid entry label
settings-invoicing-default-accounts-title = Default accounts
settings-invoicing-select-none = — Select —
settings-invoicing-load-error = Loading error
...
vat-rates-change-hint = The old rate will end on the changeover date, and the new rate will take effect on that date.
...
imported-supplier-invoices-completed = Invoice created.
imported-supplier-invoices-completed-hint = Invoice #{$id} recorded.
imported-supplier-invoices-completed-reload-failed = Import done, but the list could not be reloaded — refresh the page.
imported-supplier-invoices-discard = Discard
imported-supplier-invoices-discard-confirm = Discard this imported invoice? The supporting document is kept.
imported-supplier-invoices-discard-conflict = This invoice has already been completed or discarded by another session.
imported-supplier-invoices-discard-failed = Could not discard the invoice.
imported-supplier-invoices-discarded = Invoice discarded.
imported-supplier-invoices-doc-failed = Download failed.
imported-supplier-invoices-doc-gone = The supporting document was not restored.
imported-supplier-invoices-empty = No invoice to complete.
imported-supplier-invoices-err-amount = The line total ({$actual}) does not match the QR amount ({$expected}).
imported-supplier-invoices-err-currency = Currency not supported (CHF only).
imported-supplier-invoices-err-fiscal-year = No open fiscal year covers this date.
imported-supplier-invoices-err-form = Check the supplier, the date and each line (description, amounts, expense account).
imported-supplier-invoices-err-generic = Unexpected error.
imported-supplier-invoices-err-iban-ref = Mismatch between the IBAN and the QRR reference.
imported-supplier-invoices-err-not-found = Imported invoice not found.
imported-supplier-invoices-err-not-pending = This invoice has already been completed or discarded.
imported-supplier-invoices-error-unknown = Import failed ({$code})
imported-supplier-invoices-field-date = Invoice date
imported-supplier-invoices-field-due = Due date
imported-supplier-invoices-field-number = Supplier invoice no.
imported-supplier-invoices-field-supplier = Supplier
imported-supplier-invoices-import = Import the folder
imported-supplier-invoices-import-failed = Unexpected error during the import.
imported-supplier-invoices-import-running = An import is already running. Try again shortly.
...
imported-supplier-invoices-no-source-doc = No supporting document was imported for this invoice.
...
imported-supplier-invoices-sum-ttc = Line total incl. VAT
imported-supplier-invoices-target = QR target
imported-supplier-invoices-title = Import invoices
imported-supplier-invoices-to-complete = Invoices to complete
imported-supplier-invoices-view-doc = View the supporting document
imported-supplier-invoices-view-source = View the original invoice
imported-supplier-invoices-error-unsupported-file-type = File type not supported
imported-supplier-invoices-error-file-too-large = File too large
imported-supplier-invoices-error-symlink-rejected = Symbolic link rejected
imported-supplier-invoices-error-duplicate = Already imported (duplicate)
imported-supplier-invoices-error-no-qr-code-found = No QR-bill detected
imported-supplier-invoices-error-invalid-spc-payload = QR unreadable (not SPC format)
imported-supplier-invoices-error-invalid-iban = Creditor IBAN invalid
imported-supplier-invoices-error-pdf-render-error = PDF unreadable
imported-supplier-invoices-error-file-read-error = Could not read the file
...
supplier-invoices-settlement-cancel-confirm = Cancel this settlement? A reversing entry dated today will be posted to the general ledger, and the invoice will be open again, to be paid.
supplier-invoices-settlement-cancel-batch-warning = This invoice is part of payment batch no. { $batch }, confirmed on { $date }. If the bank executed that order, it has already been paid: correct it with a new direct settlement, never with a new batch.
supplier-invoices-settlement-cancelled = Settlement cancelled: the reversing entry has been posted and the invoice is open again.
supplier-invoices-settlement-entry-link = View the settlement entry
supplier-invoices-settlement-cancel-blocked-not-paid = This supplier invoice is not paid: there is no settlement to cancel.
supplier-invoices-col-date = Date
supplier-invoices-col-due = Due date
supplier-invoices-col-number = No.
supplier-invoices-col-status = Status
supplier-invoices-col-qty = Qty
supplier-invoices-col-vat = VAT
supplier-invoices-col-supplier = Supplier
supplier-invoices-col-total = Incl. VAT
supplier-invoices-detail-project = Project
supplier-invoices-detail-reference = Reference
supplier-invoices-detail-title = Supplier invoice
supplier-invoices-empty = No supplier invoice recorded.
supplier-invoices-err-lines = Each line requires a description, an amount and an expense account.
supplier-invoices-err-supplier = Select a supplier.
supplier-invoices-field-date = Invoice date
supplier-invoices-field-due = Due date
supplier-invoices-field-expected-amount = Expected amount incl. VAT (optional)
supplier-invoices-field-iban = IBAN / QR-IBAN (optional)
supplier-invoices-field-number = Supplier invoice no.
supplier-invoices-field-project = Project (optional)
supplier-invoices-field-qr-iban = QR-IBAN (optional)
supplier-invoices-field-reference = Reference (optional)
supplier-invoices-field-supplier = Supplier
supplier-invoices-form-close = Close
supplier-invoices-line-account = Account
supplier-invoices-line-desc = Description
supplier-invoices-line-ht = Excl. VAT
supplier-invoices-line-total = Total excl. VAT
supplier-invoices-lines = Lines
supplier-invoices-new = Record an invoice
supplier-invoices-paid-info = Invoice paid.
supplier-invoices-pay-account-ph = Counterparty account
supplier-invoices-pay-bank-ph = Source bank account
supplier-invoices-pay-date = Payment date
supplier-invoices-pay-err-account = Select an account.
supplier-invoices-pay-err-bank = Select a bank account.
supplier-invoices-pay-internal = Internal account (cash, card…)
supplier-invoices-pay-submit = Pay
supplier-invoices-pay-title = Pay the invoice
supplier-invoices-pay-transfer = Bank transfer
supplier-invoices-project-none = — None
supplier-invoices-save = Save
supplier-invoices-scan = Scan a QR-bill
supplier-invoices-scan-detected = Creditor detected
supplier-invoices-scan-failed = Could not read this image.
supplier-invoices-scan-hint = Upload an image of the QR-bill to prefill IBAN, reference and amount.
supplier-invoices-scan-no-qr = No QR code detected on this image.
...
credit-notes-col-line-total = Total excl. VAT
credit-notes-col-number = Credit note no.
credit-notes-col-qty = Qty
credit-notes-col-status = Status
credit-notes-col-total = Total excl. VAT
credit-notes-col-unit-price = Unit price
credit-notes-col-vat = VAT %
credit-notes-confirm-body = A full credit note will be created and posted immediately: it reverses this invoice’s journal entry (the customer balance returns to zero) and the invoice moves to “cancelled” status. This action is final. Continue?
credit-notes-create-button = Create a credit note
credit-notes-create-error = Credit note creation failed
credit-notes-created = Credit note created
credit-notes-download-pdf = Print / Download PDF
credit-notes-empty = No credit notes. Create one from a validated invoice to cancel it.
credit-notes-title = Credit notes
credit-notes-detail-title = Credit note
credit-notes-view-entry = View journal entry
credit-notes-view-invoice = View the cancelled invoice
credit-notes-view-list = View credit notes
...
email-templates-body-label = Message body
email-templates-conflict = Version conflict — the template was reloaded
email-templates-load-error = Loading error
email-templates-save-error = Error while saving
email-templates-restore-error = Error while restoring
email-templates-lang-tablist = Language
email-templates-restore = Restore default
email-templates-restore-confirm-action = Restore default
email-templates-restore-confirm-body = Your custom text for this combination will be deleted and replaced by the default template. This action cannot be undone.
email-templates-restore-confirm-title = Restore the default template?
email-templates-restored = Default template restored
email-templates-restoring = Restoring…
email-templates-saved = Template saved
email-templates-subject-label = Subject
email-templates-subtitle = Customise the content of the e-mails sent to your clients, per language. If you change nothing, a default template is used automatically.
email-templates-title = E-mail templates
email-templates-unknown-variables = The template contains unknown variables
email-templates-unknown-variables-list = Unknown variables:
email-templates-variables-hint = Insert these variables into the subject or body; they will be replaced when sending.
email-templates-variables-title = Available variables
nav-credit-notes = Credit notes
nav-email-templates = E-mail templates
nav-projects = Projects
nav-supplier-invoices-import = Import invoices
onboarding-address-npa-city-required = Postal code and town are required
onboarding-already-finalized = Onboarding is already complete. Please reload the page.
onboarding-field-name-hint = company — otherwise fill in first name + surname
onboarding-finalize-incomplete = Completion was not confirmed. Please reload the page.
onboarding-mode-error = Error while choosing the mode
onboarding-demo-load-error = Error while loading the demo data
onboarding-setup-start-error = Error while starting the setup
onboarding-org-type-error = Error while choosing the type
onboarding-accounting-lang-error = Error while choosing the accounting language
onboarding-name-required = Name (or first name + last name) is required
onboarding-address-save-error = Error while saving the details
onboarding-finalize-error = Finalisation failed — please try again.
onboarding-bank-required = Bank name and IBAN are required
onboarding-bank-save-error = Error while saving the bank account
onboarding-bank-skip-error = Error while skipping the bank account
onboarding-save = Save
payment-batches-cancel = Cancel batch
payment-batches-cancel-confirm = Cancel this batch? The invoices become payable again.
payment-batches-col-date = Execution
payment-batches-col-id = Batch
payment-batches-col-status = Status
payment-batches-col-total = Total
payment-batches-confirm = Confirm batch
payment-batches-confirm-hint = Once the transfer is executed in your e-banking, confirm to record the payments.
payment-batches-confirm-title = Confirm payment
payment-batches-confirmed-at = Confirmed on
payment-batches-created = Batch created
payment-batches-detail-date = Execution date
payment-batches-detail-title = Payment batch
payment-batches-download = Download pain.001 file
payment-batches-empty = No payment batch.
payment-batches-err-bank = Select a source bank account.
payment-batches-err-invoices = Select at least one invoice.
payment-batches-field-bank = Source bank account
payment-batches-field-date = Requested execution date
payment-batches-form-close = Close
payment-batches-generate = Create batch
payment-batches-item-invoice = Invoice
payment-batches-line-amount = Amount
payment-batches-lot = Batch
payment-batches-msg-id = MsgId
payment-batches-new = Create transfer batch
payment-batches-no-open = No open supplier invoice.
payment-batches-open = open and download the file
payment-batches-payment-date = Actual payment date
payment-batches-rejected = Invoices not included:
payment-batches-select-invoices = Invoices to pay by transfer
projects-archive = Archive
projects-archive-error = Operation not possible.
projects-archived = Project archived.
projects-archived-tag = archived
projects-created = Project created.
projects-edit = Edit
projects-empty = No project. Create your first project to get started.
projects-err-code = The project code is required.
projects-err-name = The project name is required.
projects-field-code = Code
projects-field-description = Description (optional)
projects-field-end = End
projects-field-name = Name
projects-field-parent = Parent project (optional)
projects-field-start = Start
projects-form-create = New project
projects-form-edit = Edit project
projects-load-error = Unable to load the projects.
projects-new = New project
projects-parent-none = — None (root project)
projects-save = Save
projects-save-error = Unable to save.
projects-show-archived = Show archived projects
projects-subtitle = Group your expenses and revenue by project (renovation, investment) to analyse them separately.
...
# --- General ledger (Story 24-1) ---
reports-ledger-title = General ledger
reports-ledger-tab = General ledger
reports-ledger-description = An account statement: what makes up its balance, line by line.
reports-ledger-account-label = Account
reports-ledger-all-accounts = All accounts with movements
reports-ledger-from = From
reports-ledger-to = To
reports-ledger-opening = Opening balance
reports-ledger-closing = Closing balance
reports-ledger-movements-total = Total movements
reports-ledger-column-piece = Voucher
reports-ledger-column-journal = Journal
reports-ledger-column-counterpart = Counterpart
reports-ledger-column-running = Running balance
reports-ledger-archived = archived
reports-ledger-unnatural = Balance against account nature
reports-ledger-unnatural-hint = This account shows a balance on the side opposite to its nature. Worth checking.
reports-ledger-fy-break = Fiscal year close — the balance restarts at zero
reports-ledger-no-movement = No movement in this period. The opening balance remains outstanding.
reports-ledger-empty = No account to display for this period.
reports-ledger-open-from-balance = See the detail in the general ledger
reports-ledger-truncated = Only the first { $shown } of { $total } lines are shown. The export contains them all.
reports-ledger-include-zero = Include accounts with no movement
reports-ledger-instruction = Pick a period, then click Generate. The account is optional.

# --- Journal d'audit — route, vocabulaire et export (Story 25-1c-a) ---
# ----------------------------------------------------------------------
#
#
audit-log-entity-account = Account
audit-log-entity-api-key = API key
audit-log-entity-bank-account = Bank account
audit-log-entity-bank-imports = Bank import
audit-log-entity-bank-profiles = Bank profile
audit-log-entity-bank-transaction = Bank transaction
audit-log-entity-company = Company
audit-log-entity-company-dunning-settings = Reminder settings
audit-log-entity-company-invoice-settings = Invoicing settings
audit-log-entity-contact = Contact
audit-log-entity-contact-person = Contact person
audit-log-entity-credit-note = Credit note
audit-log-entity-dunning-level = Reminder level
audit-log-entity-email-template = E-mail template
audit-log-entity-export = Export
audit-log-entity-fiscal-year = Fiscal year
audit-log-entity-imported-supplier-invoice = Imported invoice
...
audit-log-entity-reconciliation-rules = Reconciliation rule
audit-log-entity-report = Report
audit-log-entity-supplier-invoice = Supplier invoice
audit-log-entity-user = User
audit-log-entity-vat-rate = VAT rate
#
audit-log-action-journal-entry-created = Journal entry created
...
audit-log-action-account-archived = Account archived
audit-log-action-account-reactivated = Account reactivated
audit-log-action-account-retyped = Account type changed
audit-log-action-fiscal-year-created = Fiscal year created
audit-log-action-fiscal-year-updated = Fiscal year updated
audit-log-action-fiscal-year-closed = Fiscal year closed
audit-log-action-fiscal-year-reopened = Fiscal year reopened
audit-log-action-books-locked = Accounting period locked
audit-log-action-books-unlocked = Accounting period unlocked
audit-log-action-books-restored = Period lock restored after a restore
audit-log-action-vat-rate-created = VAT rate created
audit-log-action-vat-rate-updated = VAT rate updated
audit-log-action-vat-rate-deactivated = VAT rate deactivated
audit-log-action-invoice-created = Invoice created
audit-log-action-invoice-updated = Invoice updated
audit-log-action-invoice-validated = Invoice validated
audit-log-action-invoice-unvalidated = Invoice unvalidated
audit-log-action-invoice-cancelled = Invoice cancelled
audit-log-action-invoice-deleted = Invoice deleted
audit-log-action-invoice-emailed = Invoice sent by e-mail
audit-log-action-invoice-paid = Invoice paid
audit-log-action-invoice-partially-settled = Invoice partially paid
audit-log-action-invoice-settlement-cancelled = Settlement cancelled
audit-log-action-invoice-reminder-sent = Reminder sent
audit-log-action-invoice-reminder-cancelled = Reminder cancelled
audit-log-action-invoice-dunning-paused = Reminders paused
audit-log-action-invoice-dunning-resumed = Reminders resumed
audit-log-action-credit-note-created = Credit note created
audit-log-action-dunning-level-created = Reminder level created
audit-log-action-dunning-level-updated = Reminder level updated
audit-log-action-dunning-level-deleted = Reminder level deleted
audit-log-action-company-dunning-settings-updated = Reminder settings updated
audit-log-action-company-invoice-settings-updated = Invoicing settings updated
audit-log-action-supplier-invoice-created = Supplier invoice created
audit-log-action-supplier-invoice-cancelled = Supplier invoice cancelled
audit-log-action-supplier-invoice-paid = Supplier invoice paid
audit-log-action-supplier-invoice-settlement-cancelled = Supplier settlement cancelled
audit-log-action-imported-supplier-invoice-created = Imported invoice created
audit-log-action-imported-supplier-invoice-completed = Imported invoice completed
audit-log-action-imported-supplier-invoice-discarded = Imported invoice discarded
audit-log-action-imported-supplier-invoice-reactivated = Imported invoice reactivated
audit-log-action-payment-batch-generated = Payment batch created
audit-log-action-payment-batch-confirmed = Payment batch confirmed
audit-log-action-payment-batch-cancelled = Payment batch cancelled
audit-log-action-bank-account-created = Bank account created
audit-log-action-bank-account-updated = Bank account updated
audit-log-action-bank-account-archived = Bank account archived
audit-log-action-bank-import-created = Bank import completed
audit-log-action-bank-profile-created = Bank profile created
audit-log-action-bank-profile-updated = Bank profile updated
audit-log-action-bank-profile-deleted = Bank profile deleted
audit-log-action-reconciliation-accepted = Reconciliation accepted
audit-log-action-reconciliation-cancelled = Reconciliation cancelled
audit-log-action-reconciliation-rejected = Reconciliation rejected
audit-log-action-reconciliation-manual-matched = Manual reconciliation completed
audit-log-action-reconciliation-split-applied = Transaction split
audit-log-action-reconciliation-rule-created = Reconciliation rule created
audit-log-action-reconciliation-rule-updated = Reconciliation rule updated
audit-log-action-reconciliation-rule-deleted = Reconciliation rule deleted
audit-log-action-reconciliation-rule-applied = Reconciliation rule applied
audit-log-action-contact-created = Contact created
audit-log-action-contact-updated = Contact updated
audit-log-action-contact-archived = Contact archived
audit-log-action-contact-person-created = Contact person created
audit-log-action-contact-person-updated = Contact person updated
audit-log-action-contact-person-archived = Contact person archived
audit-log-action-product-created = Product created
audit-log-action-product-updated = Product updated
audit-log-action-product-archived = Product archived
audit-log-action-project-created = Project created
audit-log-action-project-updated = Project updated
audit-log-action-project-archived = Project archived
audit-log-action-project-unarchived = Project reactivated
audit-log-action-user-created = User created
audit-log-action-user-updated = User updated
audit-log-action-user-disabled = User disabled
audit-log-action-user-role-changed = Role changed
audit-log-action-user-password-reset = Password reset
audit-log-action-api-key-created = API key created
audit-log-action-api-key-revoked = API key revoked
audit-log-action-auth-password-reset-requested = Password reset requested
audit-log-action-auth-password-reset-completed = Password reset completed
audit-log-action-admin-break-glass-reset = Emergency administrator reset
audit-log-action-company-updated = Company updated
...
audit-log-action-admin-full-import = Backup imported
audit-log-action-exports-global = Global export completed
audit-log-action-report-generated = Report generated
audit-log-action-report-exported = Report exported
#
audit-log-actor-type-user = User
audit-log-actor-type-api-key = API key
#
audit-log-csv-header-id = No.
audit-log-csv-header-created-at = Date (UTC)
audit-log-csv-header-actor = Author
audit-log-csv-header-user-id = Author ID
audit-log-csv-header-actor-type = Author type
audit-log-csv-header-action = Action
audit-log-csv-header-entity-type = Entity type
audit-log-csv-header-entity-id = Entity ID
...
invoice-unvalidate-confirm-body = Its journal entry will be deleted and the invoice will return to draft. Its number is kept: revalidating it will reuse the same one.
invoice-unvalidate-keeps-number = Number kept:
invoice-unvalidated-success = Invoice returned to draft
