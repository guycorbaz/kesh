...
export-global-description = Export your accounting data (accounts, journal entries, contacts, products, sales invoices, bank accounts and transactions) in CSV format inside a ZIP file. Use this export to archive or keep your data for 10 years (Swiss CO art. 958f). ⚠️ It does not yet cover your whole accounting: read below what it leaves out before relying on it to migrate to another software.
...
export-global-content-excludes = Does not contain: supplier invoices and their lines, credit notes, analytic projects (journal entry lines carry a project id, but the projects table is missing), payment batches, contact persons, imported receipts, users (personal data and passwords), session tokens, internal audit log, onboarding state.
