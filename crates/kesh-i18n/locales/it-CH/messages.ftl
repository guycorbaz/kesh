...
imported-supplier-invoices-err-currency = Valuta non supportata (solo CHF nella v0.4).
imported-supplier-invoices-err-fiscal-year = Nessun esercizio aperto copre questa data.
imported-supplier-invoices-err-form = Verifica il fornitore, la data e ogni riga (descrizione, importi, conto costi).
...
imported-supplier-invoices-mismatch = scarto da correggere
...
imported-supplier-invoices-error-duplicate = Già importata (duplicato)
...
supplier-invoices-err-lines = Ogni riga richiede una descrizione, un importo e un conto costi.
