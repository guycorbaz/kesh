...
imported-supplier-invoices-err-form = Prüfen Sie den Lieferanten, das Datum und jede Zeile (Beschreibung, Beträge, Aufwandkonto).
...
imported-supplier-invoices-import = Dossier importieren
...
supplier-invoices-err-lines = Jede Zeile erfordert eine Beschreibung, einen Betrag und ein Aufwandkonto.
