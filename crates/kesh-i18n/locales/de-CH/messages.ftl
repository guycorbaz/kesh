...
export-global-description = Exportieren Sie Ihre Buchhaltungsdaten (Konten, Buchungen, Kontakte, Produkte, Ausgangsrechnungen, Bankkonten und -transaktionen) im CSV-Format in einer ZIP-Datei. Verwenden Sie diesen Export zur Archivierung oder zur 10-jährigen Aufbewahrung (Schweizerisches OR Art. 958f). ⚠️ Er deckt Ihre Buchhaltung noch nicht vollständig ab: Lesen Sie unten, was er nicht enthält, bevor Sie damit in eine andere Software migrieren.
...
export-global-content-excludes = Nicht enthalten: Eingangsrechnungen und deren Positionen, Gutschriften, Analyseprojekte (die Buchungen enthalten eine Projekt-ID, die Projekttabelle fehlt jedoch), Zahlungsläufe, Kontaktpersonen, importierte Belege, Benutzer (Personendaten und Passwörter), Session-Tokens, internes Audit-Log, Onboarding-Status.
...
invoice-validate-success-no-number = Rechnung freigegeben
