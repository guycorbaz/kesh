...
/// Révoque un refresh token par sa valeur.
///
...
pub async fn revoke_by_token(pool: &MySqlPool, token: &str) -> Result<bool, DbError> {
...
///
/// Utilisé par la story 1.7 au changement de mot de passe (invalidation
/// de toutes les sessions). Retourne le nombre de tokens effectivement
/// révoqués.
