...
- Name: journal-entries.spec.ts >> Page écritures — saisie >> indicateur de déséquilibre et bouton Valider désactivé
- Location: tests/e2e/journal-entries.spec.ts:115:2
