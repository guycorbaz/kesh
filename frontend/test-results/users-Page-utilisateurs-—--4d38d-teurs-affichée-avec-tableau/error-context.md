...
- Name: users.spec.ts >> Page utilisateurs — CRUD >> liste des utilisateurs affichée avec tableau
- Location: tests/e2e/users.spec.ts:44:2
...
Expected: visible
Error: strict mode violation: getByText('admin') resolved to 5 elements:
    1) <span class="text-sm">Admin</span> aka locator('#bits-c1').getByRole('button', { name: 'Admin' })
    2) <span class="mb-1 text-xs font-medium uppercase tracking-wider text-text-muted">Administration</span> aka getByText('Administration')
    3) <td data-slot="table-cell" class="p-2 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0">…</td> aka getByRole('cell', { name: 'admin Vous' })
    4) <td data-slot="table-cell" class="p-2 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0">…</td> aka getByRole('cell', { name: 'Admin' }).nth(1)
    5) <td data-slot="table-cell" class="p-2 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0">…</td> aka getByRole('cell', { name: 'Admin' }).nth(3)
    ...
    - generic [ref=e14]:
      ...
      - main [ref=e52]:
        - generic [ref=e53]:
          ...
          - button "Nouvel utilisateur" [ref=e55]:
            - img
              ...
              - cell "Modifier changeme Réinitialiser le mot de passe de changeme Désactiver changeme" [ref=e81]:
                - generic [ref=e82]:
                  ...
                  - button "Désactiver changeme" [ref=e85]:
                    - img
    - contentinfo [ref=e86]: Kesh v0.1.0 — Logiciel libre (EUPL 1.2). Les données ne remplacent pas un fiduciaire.
