...
- Name: journal-entries.spec.ts >> Page écritures — modification (Story 3.3) >> édition nominale — modification du libellé
- Location: tests/e2e/journal-entries.spec.ts:193:2
