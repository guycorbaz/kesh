...
- Name: mode-expert.spec.ts >> Mode toggle >> toggle mode changes data-mode attribute on html
- Location: tests/e2e/mode-expert.spec.ts:26:2
...
Call log:
  - waiting for locator('button:has-text("Mode")')
