...
- Name: journal-entries.spec.ts >> Page écritures — recherche & pagination (Story 3.4) >> filtre par libellé avec debounce
- Location: tests/e2e/journal-entries.spec.ts:316:2
