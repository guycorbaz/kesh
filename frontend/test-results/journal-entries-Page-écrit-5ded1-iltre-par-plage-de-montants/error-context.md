...
- Name: journal-entries.spec.ts >> Page écritures — recherche & pagination (Story 3.4) >> filtre par plage de montants
- Location: tests/e2e/journal-entries.spec.ts:330:2
