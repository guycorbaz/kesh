...
- Name: invoices.spec.ts >> Factures — création brouillon >> crée une facture avec 1 ligne libre + 1 ligne catalogue et persiste après reload (AC #1, #2)
- Location: tests/e2e/invoices.spec.ts:112:2
