...
- Name: journal-entries.spec.ts >> Page écritures — recherche & pagination (Story 3.4) >> tri ascendant puis descendant sur Date
- Location: tests/e2e/journal-entries.spec.ts:342:2
