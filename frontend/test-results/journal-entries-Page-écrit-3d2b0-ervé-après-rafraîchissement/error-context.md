...
- Name: journal-entries.spec.ts >> Page écritures — recherche & pagination (Story 3.4) >> URL state préservé après rafraîchissement
- Location: tests/e2e/journal-entries.spec.ts:366:2
