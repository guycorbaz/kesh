...
- Name: invoices.spec.ts >> Factures — téléchargement PDF (Story 5.3) >> télécharge le PDF d'une facture validée (golden path)
- Location: tests/e2e/invoices.spec.ts:220:2
