...
\begin{itemize}
    ...
    \item al. 3 : support libre + lien garanti + lisibilité possible → garanti par \texttt{audit\_log} + SHA-256 + format CSV ouvert du ZIP d'export. \textbf{Depuis la v0.12.1, la piste de contrôle VOYAGE avec l'export} (\texttt{audit\_log.csv}, issue \#386)~: elle n'est plus seulement conservée dans l'instance, elle part avec les livres.
\end{itemize}
