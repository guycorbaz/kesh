...
services:
  ...
  kesh-api:
    ...
    # NE PAS publier le port 3000 sur l'hôte (Traefik y accède via réseau Docker).
    expose:
      - "3000"
    networks:
      - kesh-internal
...
\begin{enumerate}
    ...
    \item Renseigner :
        \begin{itemize}
            ...
            \item \textbf{Destination} : Protocole \keshcommand{HTTP}, Hostname \keshcommand{localhost}, Port \keshcommand{3000}
        \end{itemize}
