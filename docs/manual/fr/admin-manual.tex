...
\begin{itemize}
    ...
    \item \textbf{Portée} : chaque clé est en \emph{lecture seule} (\texttt{read} --- méthodes GET uniquement) ou \emph{lecture-écriture} (\texttt{read-write}). La permission effective est l'intersection de la portée de la clé et du rôle de son créateur.
