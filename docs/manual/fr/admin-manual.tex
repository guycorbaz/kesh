...
\textbf{Le journal d'audit n'est pas inaltérable en pratique.} Deux chemins l'effacent :
l'import d'une sauvegarde \texttt{.keshbackup}, qui remplace la table par le contenu de
l'archive fournie, et la réinitialisation des données de démonstration. Aucun verrou de base
de données ne s'y oppose. Tant que ces deux chemins existent, la condition~1 repose sur la
discipline de l'exploitant, non sur un procédé technique.
