...
\begin{itemize}
    \item \textbf{Délai} : jours écoulés depuis l'échéance avant qu'un niveau ne devienne dû (cumulé avec la période de grâce ci-dessous).
...
\begin{itemize}
    \item \textbf{Conservation} : les rappels suivent la rétention comptable de 10 ans (CO Art. 958f al. 1), garantie par la persistance MariaDB.
