...
\begin{enumerate}
    ...
    \item Déconnectez-vous, cliquez \emph{Mot de passe oublié ?}, saisissez votre identifiant.
...
\begin{itemize}
    ...
    \item \textbf{Arrêt du serveur pendant l'envoi} : l'email part en tâche de fond après la réponse ; un redémarrage du conteneur à cet instant précis peut perdre l'envoi (sans trace). Il suffit de refaire une demande.
\end{itemize}
