...
\begin{itemize}
    \item Architecture multi-tenant : plusieurs sociétés isolées sur une seule instance (chaque utilisateur est rattaché à une société, \texttt{company\_id} porté par le jeton).
