# Manuels Kesh — Traductions italiennes (Italiano)

⚠️ **Statut** : Traductions italiennes **non encore créées**. La version canonique est le français dans `../fr/`.
...
1. Copier le fichier source canonique depuis `../fr/` :
   ...
   ```
2. Adapter le préambule pour charger babel italien :
   ```latex
...
6. Reviewer par native speaker IT (référence Story 9-1 L4 v0.2).
